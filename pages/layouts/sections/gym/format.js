...
const featureData = [
  ...
  },
  {
    ...
    subtitle:
      "Parturient vitae arcu mollis nulla. Velit ligula amet quis eget.",
  },
  {
...
const Format = () => (
  <section
    ...
    style={{ backgroundImage: "url('/assets/images/OTF/home/features.webp')" }}
  >
              ...
              <Col md="6" key={i} className="mb-4">
                <Row>
                  ...
                  <Col
                    sm={10}
                    className={
                      "d-flex flex-column justify-content-center align-items-start formatedetailDiv"
                    }
                  >
                    <h4 className="formatHeading">{x.title}</h4>
                    <p className="p-light formatsubHeading">{x.subtitle}</p>
                  </Col>
                </Row>
              </Col>
            ))}
