  ...
  const sliderData = [
    {
      ...
      detail:
        "No matter what your fitness level is, 2 to 4 workout a week is all you need to maximize your results at Orangetheory. Let’s find the membership option that works best for you.",
  ...
  return (
    <div>
      ...
      <ScheduleSection
        ...
        detail={
          "Orangetheory Fitness is more than just a workout. It's an employee-engaging, productivity-elevating experience designed to give your company More Bottom Line and give your employees More Life, one class at a time."
        }
        list={list}
        btnText="Avail now"
      ...
      <Benefits benefitList={benefitList} />
