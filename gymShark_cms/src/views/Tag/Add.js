...
export default withRouter(function AddTag(props) {
    ...
    useEffect(() => {
        if (id && id != null) {
            LangAPI.get(`/tags/${id}`).then((response) => {
    ...
    const handleSubmit = () => {
        ...
        if (id && id != null) {
            ...
            LangAPI.put(`/tags/${id}`, finalRoom).then((response) => {
