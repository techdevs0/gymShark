...
exports["default"] = exports.useScreen = void 0;
...
var useScreen = function useScreen() {
  ...
  var getScreen = function getScreen() {
    return (0, _utils.mapWidthToScreen)(getWindowWidth(iWindow), breakpoints);
  };
  ...
  var updater = _react["default"].useRef((0, _debounce["default"])(function () {
    setScreen(getScreen());
  }, 200));
