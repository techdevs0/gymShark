...
import { EdgeSidebarConfig } from "./Config";
...
export interface ISidebarEffectCreator extends IEffectCreator<EdgeSidebarConfig, ISidebarEffect> {
}
export interface ISidebarStateEffectCreator extends IStateEffectCreator<ISidebarEffect> {
}
